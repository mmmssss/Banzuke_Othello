...
public class Client extends JFrame implements ActionListener {
	...
	private Font font;
	private int rate2;
	private ImageIcon gifIcon1 = new ImageIcon("img/W2B.gif");
	private ImageIcon gifIcon2 = new ImageIcon("img/B2W.gif");
	private ImageIcon newI = new ImageIcon("img/whiteNew.jpg");
	private ImageIcon newI2 = new ImageIcon("img/blackNew.jpg");
	...
	public Client(Othello game, Player player) { //OthelloオブジェクトとPlayerオブジェクトを引数とする
		try{
			...
			whiteIcon = new ImageIcon("img/WhiteNew.jpg");
			blackIcon = new ImageIcon("img/BlackNew.jpg");
			boardIcon = new ImageIcon("img/GreenFrame.jpg");
			highlightIcon = new ImageIcon("img/highlight.jpg");
			gameIcon = new ImageIcon("img/game.jpg");
			titleIcon = new ImageIcon("img/title.jpg");
			loginIcon = new ImageIcon("img/login.jpg");
			rankingIcon = new ImageIcon("img/ranking.jpg");
			rankingIcon2 = new ImageIcon("img/ranking2.jpg");
			resignIcon = new ImageIcon("img/resign.jpg");
			backIcon = new ImageIcon("img/back.jpg");
			backIcon2 = new ImageIcon("img/back2.jpg");
			turnBlack = new ImageIcon("img/turnBlack.jpg");
			turnWhite = new ImageIcon("img/turnWhite.jpg");
			turnBar = new ImageIcon("img/turnBar.jpg");
			catPic = ImageIO.read(new File("img/cat.png"));
			font = Font.createFont(Font.TRUETYPE_FONT,new File("font/ackaisyo.ttf"));
			...
			BufferedImage birdPic = ImageIO.read(new File("img/bird.jpg"));
			JLabel birdLabel = new JLabel(new ImageIcon(birdPic));
			birdLabel.setBounds(50, 30, 601, 800);

			BufferedImage othelloPic = ImageIO.read(new File("img/title.jpg"));
